  ...
  return (
    <div className="flex flex-col sm:gap-4 ">
      ...
      <div className="flex flex-col gap-4 lg:w-80">
        ...
        <div className="flex">
            <p className="text-sm sm:text-xs sm:w-64 w-60 inline-block font-semibold text-gray-500">Book a meeting with our Fibery team. Talk to a real person about how to get your processes set up with us
